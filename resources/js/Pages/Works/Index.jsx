        ...
        <WelcomeLayout path={path}>
          <section className="px-3 md:px-7 lg:mt-20 lg:mx-40 lg:my-14 lg:px-11">
            <div className="grid grid-cols-1 gap-6 p-6 md:grid-cols-2 lg:grid-cols-3">
                {pages.map((page) => (
                    <a href={route('works.show', page['id'])} key={page.id} className="relative overflow-hidden transition duration-300 border rounded-lg shadow-md cursor-pointer group hover:scale-105">
